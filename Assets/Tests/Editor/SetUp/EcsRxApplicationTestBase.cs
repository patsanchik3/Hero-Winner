...
{
    public abstract class EcsRxApplicationTestBase : TestBase, IEcsRxApplication
    {
        ...
        protected List<IEcsRxPlugin> _plugins { get; private set; }
        

        protected override void PostInstall(DiContainer container)
        {
            Container = new ZenjectDependencyContainer(container);
            _plugins = new List<IEcsRxPlugin>();
            StartApplication();
        }

        protected override void StopApplication(DiContainer container)
        {
            StopApplication();
        }
